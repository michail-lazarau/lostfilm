...
final class MockCountyService: CountryServiceProtocol {

    let testCountriesData = [Country(id: "BY", name: "Republic of Belarus", cities: [City(id: "MSK", name: "Minks"), City(id: "MSK1", name: "Minks1"), City(id: "MSK2", name: "Minks2"), City(id: "MSK3", name: "Minks3")]),
    ...
    func getCountries(_ cities: @escaping ([lostfilm.Country]) -> Void) {
        cities(testCountriesData)
    }
}
